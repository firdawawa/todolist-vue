                ...
                <div class="card-body">
                    ...
                    <div class="block max-w p-6 mt-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-100 dark:border-gray-300">
                        <div class="relative content-center overflow-x-auto">
                            ...
                            <div class="col-number mb-3">
                                <button type="button" @click="savePhone" class="mt-6 w-40 text-white bg-primary hover:bg-pink-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-md float-end px-5 py-3 me-2 mb-2 dark:bg-primary dark:hover:bg-pink-700 focus:outline-none dark:focus:ring-pink-900">
                                    Save
                                </button>
                            </div>
                        </div>
